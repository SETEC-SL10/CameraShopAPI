...
@Repository
public interface OldCameraFormDAO {

	String F_ProductForm = "SELECT * FROM view_camera_old_form LIMIT #{limit} OFFSET #{page} * #{limit}";
	
	String F_A_Image = "SELECT * FROM view_camera_old_image_form WHERE serial = #{serial} AND status = true";
